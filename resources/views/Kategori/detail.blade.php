                ...
                <div class="card-body d-flex flex-column justify-content-between">
                    ...
                    <div class="button-area">
                        <button class="btn-sm btn-info px-2">
                            <a href="/buku/{{ $item['id'] }}" style="text-decoration: none; color:white;">Detail</a>
                        </button>
                        ...
                        <button class="btn-sm btn-danger px-3">
                            <a data-toggle="modal" data-target="#DeleteModal{{ $item['id'] }}">Delete</a>
                        </button>
                    </div>
                    @endif
                    ...
                    <div class="button-area">
                        ...
                        <button class="btn-sm btn-danger mx-1 px-3">
                            <a href="/buku/{{ $item['id'] }}" style="text-decoration: none; color:white;">Pinjam
                                Buku</a>
                        </button>
                    </div>
                    @endif
